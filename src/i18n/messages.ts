...
const es: Messages = {
  ...
  'waitlist.title': 'Lista de espera Radar Pro',
  'waitlist.submit': 'Unirme a la lista de espera de Radar Pro',
  ...
  'waitlist.consent': 'Acepto recibir comunicaciones sobre Radar Pro',
...
const en: Messages = {
  ...
  'waitlist.title': 'Radar Pro waitlist',
  'waitlist.submit': 'Join the Radar Pro waitlist',
  ...
  'waitlist.consent': 'I agree to receive Radar Pro communications',
...
const pt: Messages = {
  ...
  'waitlist.title': 'Lista de espera Radar Pro',
  'waitlist.submit': 'Juntar-me à lista de espera Radar Pro',
  'waitlist.earlyAccess': 'Reservar early access',
  ...
  'waitlist.consent': 'Aceito receber comunicações sobre o Radar Pro',
...
const it: Messages = {
  ...
  'waitlist.title': 'Lista d\'attesa Radar Pro',
  'waitlist.submit': 'Unisciti alla lista d\'attesa Radar Pro',
  ...
  'waitlist.consent': 'Accetto di ricevere comunicazioni su Radar Pro',
