...
const ES: ProReportPageCopy = {
  ...
  trustStrip: [
    { value: '8+', label: 'Bloques de análisis' },
  ...
  salesSubtitle: 'Un pago único por inmueble/escenario. Desbloquea rentabilidad neta, análisis avanzado y PDF para decidir con datos.',
...
const EN: ProReportPageCopy = {
  ...
  salesSubtitle: 'One payment per property/scenario. Unlock net yield, advanced analysis and PDF to decide with data.',
...
const PT: ProReportPageCopy = {
  ...
  salesSubtitle: 'Pagamento único por imóvel/cenário. Desbloqueie rentabilidade líquida, análise avançada e PDF para decidir com dados.',
...
const IT: ProReportPageCopy = {
  ...
  salesSubtitle: 'Pagamento unico per immobile/scenario. Sblocca rendimento netto, analisi avanzata e PDF per decidere con i dati.',
