...
export const MARKETS: MarketConfig[] = [
  {
    ...
    seo: SEO_PROFILES.es,
    radar: { enabled: true, waitlistEnabled: true, demoEnabled: true, authorizedProviderEnabled: false, supportedStrategies: ['long_term_rental', 'room_rental', 'renovate_and_rent'], dataSourceMessage: RADAR_MSG },
  ...
  },
  {
    ...
    seo: SEO_PROFILES.pt,
    radar: { enabled: true, waitlistEnabled: true, demoEnabled: true, authorizedProviderEnabled: false, supportedStrategies: ['long_term_rental', 'room_rental', 'renovate_and_rent'], dataSourceMessage: 'Dados fictícios para demonstração. Integrações requerem autorização.' },
  ...
  },
  {
    ...
    seo: SEO_PROFILES.it,
    radar: { enabled: true, waitlistEnabled: true, demoEnabled: true, authorizedProviderEnabled: false, supportedStrategies: ['long_term_rental', 'room_rental', 'renovate_and_rent'], dataSourceMessage: 'Dati dimostrativi fittizi. Le integrazioni richiedono autorizzazione.' },
  ...
  },
  {
    ...
    seo: SEO_PROFILES.uk,
    radar: { enabled: true, waitlistEnabled: true, demoEnabled: true, authorizedProviderEnabled: false, supportedStrategies: ['long_term_rental', 'room_rental'], dataSourceMessage: 'Fictional demo data. Portal integrations require authorization.' },
  ...
  },
  {
    ...
    seo: SEO_PROFILES.us,
    radar: { enabled: true, waitlistEnabled: true, demoEnabled: true, authorizedProviderEnabled: false, supportedStrategies: ['long_term_rental', 'room_rental', 'short_term_rental'], dataSourceMessage: 'Fictional demo data. Portal integrations require authorization.' },
    legal: legal('Indicative tool only. Not financial, tax or legal advice.'),
