export default function AuthorizedDataNotice() {
  return (
    <div className="rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-900">
      ...
      <p className="mt-2">
        Compatible con fuentes autorizadas. Preparado para integraciones de datos inmobiliarios. Puedes
        analizar manualmente cualquier inmueble que estés estudiando.
      </p>
    </div>
  );
}
